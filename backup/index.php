...
<html>
	...
	<a href="https://line.me/R/ti/g/XBxPiCTuLk" target="_blank"> <h2> Click This Link First -> Join Line Group for take Line Notify </h2> </a> <br>
	<a href="https://line.me/R/ti/g/XBxPiCTuLk" target="_blank"> <h2> กดปุ่ม หรือ แอด QR Code เพื่อเข้าไลน์ จำลองเป็น แม่ค้า เพื่อรับ Message ว่ามีลูกค้าสั่งสินค้า ได้เลย </h2> </a> <br>
	<img src="line.jpg"> <br>

	<form method="post" action="services/send_line_service.php">
		<input type="hidden" name="hidden_name" value="<?php echo $values["item_quantity"] ?>" />
		...
		<input type="hidden" name="message" value="Order มาแล้วจร้า  ยังไมได้รับค่า จาก Form เดะทำต่อ" />
			...
			<a>
		 		<button type="submit" class="btn btn-secondary btn-block" style="background-color:#233268;color:white; max-width:200px"> <h4 style="text-align:center;font-size:16px;font-weight:bold;font-family:Kanit,sans-serif;">สั่งซื้อสินค้า
			</h4> </button>
		</a>
	</form>
	</center>
